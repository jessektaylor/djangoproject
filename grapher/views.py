...
from . forms import RedditBarForm
...
class CustomFormater():
    def __init__(self, num=30, days=50, subreddits=None):
        self.__output = dict()
...
class RedditSubsBar(object):
    ...
    def get_bar_chart_obj(self, bar_quantity, subreddits, days=10, **kwargs):
        tool = CustomFormater(num=bar_quantity, days=days, subreddits=subreddits)
        subreddit_data = dict()
        dataset = list()
        labels = []
